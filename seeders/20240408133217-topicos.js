...
module.exports = {
    ...
    for (const area in topics) {
      for (const materia of topics[area]) {
        await queryInterface.sequelize.query(
          `INSERT INTO Topico (nome, id_area, createdAt, updatedAt) VALUES ('${materia.nome}', ${materia.id_area}, NOW(), NOW())`
        );
      }
    }
 },
 ...
 down: async (queryInterface, Sequelize) => {
    ...
    await queryInterface.sequelize.query(`ALTER TABLE Topico AUTO_INCREMENT = 1`); // Resetando o auto-incremento
 }
};